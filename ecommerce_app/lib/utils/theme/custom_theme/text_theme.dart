...
class TTextTheme {
  ...
  titleMedium: const TextStyle().copyWith(fontSize: 16.8, fontWeight: FontWeight.w500, color: Colors.black),
  ...
  titleMedium: const TextStyle().copyWith(fontSize: 16.8, fontWeight: FontWeight.w500, color: Colors.white),
